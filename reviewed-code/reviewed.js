...
//after this, I use join on this array, passing a '\n' to the argument and adding  the return of this join on the HTML. I used that way to make the code more readable and more organized.
    var writeOrderDetails = function (order, payment_info) {
      ...
      document.body.appendChild(finalHtml.join('\n'));
    };
